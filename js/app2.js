...
$('.doctors-carousel').flickity({
    sync: '.doctors-carousel-nav',
    cellAlign: 'left',
    contain: true,
    draggable: true,
    groupCells: 1,
...
if($('div').is('.doctors-carousel-nav')) {

  var flicktyNav = new Flickity('.doctors-carousel-nav', {
  ...
  // previous
//var previousButton = document.querySelector('.doctors-carousel-nav__prev');
// previousButton.addEventListener( 'click', function() {
//   flicktyNav.previous();
// });
$('.doctors-carousel-nav__prev').click(function() {
     flicktyNav.previous();
});
// next
//var nextButton = document.querySelector('.doctors-carousel-nav__next');
// nextButton.addEventListener( 'click', function() {
//   flicktyNav.next();
// });
$('.doctors-carousel-nav__next').click(function() {
    flicktyNav.next();
});
